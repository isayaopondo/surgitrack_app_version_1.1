...
class Authentication
{
     ...
     */
    public function user_status($requirement,$facility='')
    {
        ...
        if (!empty($this->auth_identifiers)) {
            ...
            if ($auth_data = $this->check_login($requirement,$facility))
                return $auth_data;
     ...
     * @return  mixed  either an object containing the user's data or FALSE
     */
    public function check_login($requirement,$facility)
    {
        // Keep post system session check from running
        $this->post_system_sess_check = FALSE;
    ...
    /**
     * Handle a facility check, or determine if user already logged in.
     *
     * @param   mixed  a user level (int) or an array of user roles
     * @return  mixed  either an object containing the user's data or FALSE
     */

    public function check_facilities($requirement,$facility)
    {
        // Keep post system session check from running
        $this->post_system_sess_check = FALSE;
