...
class BulkSMS {
    ...
    public function __construct() {
        ...
        $this->username = BULK_SMS_USER;
        $this->password = BULK_SMS_PASS;
        $this->msisdn = '44123123123';
        $this->url = EAPI_URL;
    }

    public function send_SMS($seven_bit_msg, $msisdn) {
    /*
         * Sending 7-bit message
         */
        $post_body = $this->seven_bit_sms($this->username, $this->password, $seven_bit_msg, $msisdn);
        $result = $this->send_message($post_body, $this->url);
        if ($result['success']) {
    ...
    private function send_message($post_body, $url) {
        /*
