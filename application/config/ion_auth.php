 ...
 */
$config['site_title'] = "Surgitrack.co.za";       // Site Title, example.com
$config['admin_email'] = "admin@surgitrack.co.za"; // Admin Email, admin@example.com
...
$config['send_activation_mail'] = 'email';
 ...
 */
$config['email_forgot_password'] = 'forgot_password-html.php';
/*
  | -------------------------------------------------------------------------
...
$config['message_start_delimiter'] = '<p><div role="alert" class="alert alert-success alert-dismissible fade in">
                                                <button type="button" data-dismiss="alert" aria-label="Close" class="close">
                                                <span aria-hidden="true">&times;</span>
                                                </button>
                                                <strong>Success!</strong>';  // Message start delimiter
$config['message_end_delimiter'] = '</div></p>';  // Message end delimiter
$config['error_start_delimiter'] = '<p>
                                            <div role="alert" class="alert alert-warning alert-dismissible fade in">
                                            <button type="button" data-dismiss="alert" aria-label="Close" class="close">
                                            <span aria-hidden="true">&times;</span>
                                            </button>
                                            <strong>Error! </strong>';  // Error message start delimiter
