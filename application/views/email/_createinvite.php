    ...
    <table width="80%" border="0" cellpadding="0" cellspacing="0">
        <tr>
            ...
            <td align="left" width="95%" style="font: 13px/18px Arial, Helvetica, sans-serif;">
                ...
                <br />
                <big style="font: 16px/18px Arial, Helvetica, sans-serif;"><b><a href="http://app.surgitrack.co.za/login" style="color: #3366cc;">Continue....</a></b></big><br />
                <br />
                Link doesn't work? Copy the following link to your browser address bar:<br />
                <nobr><a href="http://app.surgitrack.co.za/login" style="color: #3366cc;">http://app.surgitrack.co.za/login</a></nobr><br />
                <br />
