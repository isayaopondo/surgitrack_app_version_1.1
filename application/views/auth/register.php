...
<header id="header">
    ...
    <span id="extr-page-header-space"> <span class="hidden-mobile hidden-xs">Already registered?</span> <a href="<?= base_url('auth/login') ?>" class="btn btn-danger">Sign In</a> </span>
        ...
        <div class="row">
            ...
            <div class="col-xs-12 col-sm-12 col-md-5 col-lg-5">
                <div class="well no-padding">
                    ...
                    <form action="<?php echo site_url("auth/create_account"); ?>" method="POST" id="smart-form-register" class="smart-form client-form">
                        <header>
                            Registration 
                        </header>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body custom-scroll terms-body">
                ...
                <div id="left">
                    ...
                    <h2>About these website terms and conditions</h2><p>We created these website terms and conditions with the help of a free website terms and conditions form developed by Contractology and available at <a href="http://www.SurgiTrack.com">www.SurgiTrack.com</a>.
                ...
                <p><strong>By using this  WEBSITE TERMS AND CONDITIONS template document, you agree to the 
                        ...
                        <a href="#">SurgiTrack.com</a>.  You must retain the credit 
