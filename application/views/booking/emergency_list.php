...
<div id="ribbon">
    ...
    <!-- breadcrumb -->
    <ol class="breadcrumb">
        <li>Home</li><li>Theatre</li><li><span style="font-weight:bold; color:red;">Emergency List</span></li>
    </ol>
    <!-- end breadcrumb -->
    ...
    <section id="widget-grid" class="">
        ...
        <div class="row">
            ...
            <article class="col-sm-12 col-md-12 ">
                ...
                <div class="jarviswidget jarviswidget-color-red" id="wid-id-1" data-widget-editbutton="false" data-widget-custombutton="false" data-widget-deletebutton="false"
                    ...
                    <header>
                        ...
                        <div class="widget-toolbar">
                            ...
                            <div class="btn-group">
                                <a href="<?= base_url('patients/add_patient?st=emergency') ?>" class="btn btn-block btn-warning " type="button">
                                    <i class="fa fa-plus-circle"></i> Add New Emergency
                                </a>
                            </div>
                            <div class="btn-group">
                            ...
                            <div class="btn-group">
                                <button class="btn btn-default  dropdown-toggle" data-toggle="dropdown">
                                    <i class="fa fa-print"></i> Print Emergency List <span class="caret"></span>
                                </button>
                                <ul class="dropdown-menu">
                                    <li>
                                        <a href="#" onclick="print_emergency_list();">Full List</a>
                                    </li>
                                    <li class="divider"></li>
                                    <li>
                    ...
                    <div>
                        ...
                        <div class="widget-body no-padding">
                            ...
                            <table id="emergencylist_table" class="display projects-table table table-striped table-bordered table-hover" width="100%">
