...
<div id="ribbon">
    ...
    <!-- breadcrumb -->
    <ol class="breadcrumb">
        <li>Home</li><li>Theatre</li><li>Discharge Summaries</li>
    </ol>
    <!-- end breadcrumb -->
                ...
                <div class="jarviswidget jarviswidget-color-blueDark" id="wid-id-1" data-widget-editbutton="false" data-widget-custombutton="false" data-widget-deletebutton="false"
                    ...
                    <div>
                        ...
                        <div class="widget-body no-padding">
                            ...
                            <table id="discharge_table" class="display projects-table table table-striped table-bordered table-hover" width="100%">
                                <thead>
                                <tr>
                                    <th style="width:4%"></th>
                                    <th style="width:4%"></th>
