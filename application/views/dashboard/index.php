                                ...
                                <div class="tab-pane fade active in padding-10 no-padding-bottom" id="s1">
                                    ...
                                    <div class="show-stat-microcharts">
                                        <div class="col-xs-12 col-sm-3 col-md-3 col-lg-3">
                                            ...
                                            <span class="easy-pie-title"> Case Load <i class="fa fa-caret-up icon-color-bad"></i> </span>
                                        ...
                                        <div class="col-xs-12 col-sm-3 col-md-3 col-lg-3">
                                            ...
                                            <span class="easy-pie-title"> Open Slots <i class="fa fa-caret-down icon-color-good"></i></span>
                                            <ul class="smaller-stat hidden-sm pull-right">
                                                <li>
                                        ...
                                        <div class="col-xs-12 col-sm-3 col-md-3 col-lg-3">
                                            ...
                                            <span class="easy-pie-title"> Completed <i class="fa fa-caret-up icon-color-good"></i></span>
                                            <ul class="smaller-stat hidden-sm pull-right">
                                                <li>
                                        ...
                                        <div class="col-xs-12 col-sm-3 col-md-3 col-lg-3">
                                            ...
                                            <span class="easy-pie-title"> Performance <i class="fa fa-caret-down icon-color-good"></i></span>
                                            <ul class="smaller-stat hidden-sm pull-right">
                                                <li>
